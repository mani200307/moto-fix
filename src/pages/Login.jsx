...
const Login = () => {
    ...
    return (
        <div className='flex flex-col justify-center h-screen items-center'>
            <div className="bg-base-100 flex-col justify-center items-center gap-2 shadow-lg rounded-lg p-5 w-fit">
                ...
                <div className='flex flex-col justify-center items-center gap-3'>
                    ...
                    <h1 className='text-sm'>New User? <a href='/signup' className='text-sm text-blue-500'>Sign up</a></h1>
                </div>
            </div>
        </div>
    )
